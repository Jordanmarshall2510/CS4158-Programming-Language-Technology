...
{
       0,     0,     3,     7,    10,    12,    16,    20,    23,    25,
      27,    29,    31,    33,    36,    40,    44,    47,    50,    53,
      56,    60,    66,    72,    78,    84
};
...
{
      18,     0,    -1,     6,    15,    19,    -1,    20,    19,    -1,
      21,    -1,     4,     5,    15,    -1,     7,    15,    22,    -1,
      23,    22,    -1,    30,    -1,    24,    -1,    26,    -1,    28,
      -1,    29,    -1,    12,    25,    -1,    16,    14,    25,    -1,
       5,    14,    25,    -1,    16,    15,    -1,     5,    15,    -1,
      11,    27,    -1,     5,    15,    -1,     5,    14,    27,    -1,
       9,     3,    13,     5,    15,    -1,     9,     5,    13,     5,
      15,    -1,    10,     3,    13,     5,    15,    -1,    10,     5,
      13,     5,    15,    -1,     8,    15,    -1
};
...
{
       0,    44,    44,    46,    47,    49,    51,    53,    54,    56,
      57,    58,    59,    61,    63,    64,    65,    66,    68,    70,
      71,    73,    74,    76,    77,    79
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "INT_SIZE", "IDENTIFIER",
  "BEGINING", "BODY", "END", "MOVE", "ADD", "INPUT", "PRINT", "TO",
  "SEMICOLON", "TERMINATOR", "STRING", "$accept", "start", "declarations",
  "declaration", "body", "code", "line", "print", "printStatement",
  "input", "inputStatement", "move", "add", "end", 0
};
#endif
...
{
       1,     4,    16,     2,   -31,    19,    10,   -31,     2,   -31,
      11,    -7,   -31,   -31,    12,     5,     9,    23,    -5,   -31,
      -7,   -31,   -31,   -31,   -31,   -31,   -31,    17,    18,    20,
      21,     3,   -31,     6,     8,   -31,   -31,    24,    27,    30,
      31,    23,   -31,    -5,   -31,    -5,   -31,    22,    25,    26,
...
static const yytype_uint8 yytable[] =
{
      ...
      28,    34,    29,    52,    30,    53,     4,    41,    42,     3,
      43,    44,    45,    46,    10,    11,    13,    26,    31,    47,
      37,    38,    48,    39,    40,    49,    50,    54,    51,     0,
      55,    56,    12,    57,     0,     0,     0,     0,     0,    36
};

static const yytype_int8 yycheck[] =
{
       5,     8,     9,    10,    11,    12,     4,     6,     3,     7,
       5,    16,     3,    43,     5,    45,     0,    14,    15,    15,
      14,    15,    14,    15,     5,    15,    15,    15,     5,     5,
      13,    13,     5,    13,    13,     5,     5,    15,    41,    -1,
      15,    15,     8,    15,    -1,    -1,    -1,    -1,    -1,    20
};
...
{
       0,     6,    18,    15,     0,     4,     7,    19,    20,    21,
       5,    15,    19,    15,     8,     9,    10,    11,    12,    22,
      23,    24,    26,    28,    29,    30,    15,     3,     5,     3,
       5,     5,    27,     5,    16,    25,    22,    13,    13,    13,
      13,    14,    15,    14,    15,    14,    15,     5,     5,     5,
       5,    27,    25,    25,    15,    15,    15,    15
};
...
#line 47 "parser.y"
  ...
  case 5:
#line 49 "parser.y"
    { createVariable((yyvsp[(1) - (3)].size), (yyvsp[(2) - (3)].id)); ;}
    break;
...
#line 71 "parser.y"
  ...
  case 21:
#line 73 "parser.y"
    { moveIntegerToVariable((yyvsp[(2) - (5)].number), (yyvsp[(4) - (5)].id)); ;}
    break;

  case 22:
#line 74 "parser.y"
    { moveVariableToVariable((yyvsp[(2) - (5)].id), (yyvsp[(4) - (5)].id)); ;}
    break;
